...
func init() {
	...
	Errors["undefUser"] = GetErr("Пользователь не известен")
	...
	Errors["permission"] = GetErr("Не достаточно прав пользоватля")
	Errors["notFound"] = GetErr("Упс. Я не понимаю чего Вы хотите")
	Errors["notImplement"] = GetErr("Method not implemented")
	Errors["notAllowed"] = GetErr("У Вас нет прав на осуществление данной операции")
